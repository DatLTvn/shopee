...
<?php $__env->startSection('admin_content'); ?>
    ...
    <div>
        ...
        <button type="submit" form="frm_filter" name='key' class="btn btn-primary pull-right">Tìm kiếm</button>
        <a href="<?php echo e(URL::to('/all-edit-category-product')); ?>" class="btn btn-primary mr-3  pull-right">Xóa tìm</a>
    </div>
...
<?php echo $__env->make('admin_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\relaravel\resources\views/admin/all_category_product.blade.php ENDPATH**/ ?>