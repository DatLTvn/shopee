...
<!DOCTYPE HTML>
<head>
<title>Home Shoppe for Iphone, Android and Smartphone Website Templates | About :: Isource</title>
...
<script type="text/javascript" src="smartphone/js/jquery-1.7.2.min.js"></script> 
</head>
<body>
  <div class="wrap">
	<div class="header">
	        ...
	        <nav class="nav">
	            <ul class="nav-list">
	                ...
	                <li class="nav-item has-inner">
	                    <a href="#">Categories</a>
	                    <ul class="nav-inner">
	                          <li><a href="index.html">Mobile Phones</a></li>
						      ...
						      <li><a href="index.html">Software</a></li>
						       <li><a href="index.html">Sports &amp; Fitness</a></li>
						       <li><a href="index.html">Footwear</a></li>
						       <li><a href="index.html">Jewellery</a></li>
						       <li><a href="index.html">Clothing</a></li>
						       <li><a href="index.html">Home Decor &amp; Kitchen</a></li>
						       <li><a href="index.html">Beauty &amp; Healthcare</a></li>
						       <li><a href="index.html">Toys, Kids &amp; Babies</a></li>
	                    </ul>
	                </li>
    ...
    <div class="content">
    	<div class="section group">
				<div class="col_1_of_3 span_1_of_3">
					<h3>Who We Are</h3>
					<img src="smartphone/images/about_img.jpg" alt="">
				...
				<div class="col_1_of_4 span_1_of_4">
					<h4>Contact</h4>
						...
						<div class="social-icons">
							<h4>Follow Us</h4>
					   		  <ul>
							      <li><a href="#" target="_blank"><img src="smartphone/images/facebook.png" alt="" /></a></li>
							      <li><a href="#" target="_blank"><img src="smartphone/images/twitter.png" alt="" /></a></li>
							      <li><a href="#" target="_blank"><img src="smartphone/images/skype.png" alt="" /> </a></li>
							      <li><a href="#" target="_blank"> <img src="smartphone/images/dribbble.png" alt="" /></a></li>
							      <li><a href="#" target="_blank"> <img src="smartphone/images/linkedin.png" alt="" /></a></li>
							      <div class="clear"></div>
						     </ul>
   	 					</div>
				</div>
...
<?php /**PATH C:\xampp\htdocs\relaravel\resources\views/smartphone/about.blade.php ENDPATH**/ ?>