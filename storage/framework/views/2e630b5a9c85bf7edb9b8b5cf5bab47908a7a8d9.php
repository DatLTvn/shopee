        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="<?php echo e(URL::to('/all-category-product')); ?>">Sản phẩm</a></li>
...
<!-- calendar -->
	<script type="text/javascript" src="<?php echo e(('public/backend/js/monthly.js')); ?>"></script>
...
<?php /**PATH C:\xampp\htdocs\laravel4\resources\views/admin_layout.blade.php ENDPATH**/ ?>