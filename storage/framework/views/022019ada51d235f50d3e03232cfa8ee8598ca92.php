    ...
    <div class="content">
    	<div class="image group">
				<div class="grid images_3_of_1">
					<img src="<?php echo e(asset('public/smartphone/images/newsimg1.jpg')); ?>" alt="" />
				</div>
		   ...
		   <div class="image group">
				<div class="grid images_3_of_1">
					<img src="<?php echo e(asset('public/smartphone/images/newsimg2.jpg')); ?>" alt="" />
				</div>
				<div class="grid news_desc">
					<h3>Lorem Ipsum is simply dummy text </h3>
		   ...
		   <div class="image group">
				<div class="grid images_3_of_1">
					<img src="<?php echo e(asset('public/smartphone/images/newsimg3.jpg')); ?>" alt="" />
				</div>
				<div class="grid news_desc">
					<h3>Lorem Ipsum is simply dummy text </h3>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\relaravel\resources\views/smartphone/new_sp.blade.php ENDPATH**/ ?>