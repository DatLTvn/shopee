  ...
  <div class="wrap">
	<div class="header">
		...
		<div class="header_top">
			<div class="logo">
				<a href="<?php echo e(URL::to('/')); ?>"><img src="<?php echo e(asset('public/web/images/logo.png')); ?>" alt="" /></a>
			</div>
			  <div class="cart">
			...
			<div class="header_bottom_left">				
				<div class="categories">
				  <ul>
				      ...
				      <li><a href="<?php echo e(route('category',$item->category_slug)); ?>"><?php echo e($item->category_name); ?></a></li>
			                    ...
			                    <div id="mover">
			                    	<div id="slide-1" class="slide">			                    
									 <div class="slider-img">
									     <a href="preview.html"><img src="<?php echo e(asset('public/web/images/slide-1-image.png')); ?>" alt="learn more" /></a>									    
										</div>
									  ...
									  <div class="clear"></div>				
									   ...
									   <div class="features_list">
							             ...
							             <a href="preview.html" class="button">Shop Now</a>
						             	 ...
						             	 <div class="slider-img">
									     <a href="preview.html"><img src="<?php echo e(asset('public/web/images/slide-3-image.jpg')); ?>" alt="learn more" /></a>
									  </div>						             					                 
									  <div class="clear"></div>				
				                  </div>
				                  <div class="slide">						             	
					                  <div class="slider-img">
									     <a href="preview.html"><img src="<?php echo e(asset('public/web/images/slide-2-image.jpg')); ?>" alt="learn more" /></a>
									  </div>
									  <div class="slider-text">
		                                 <h1>Clearance<br><span>SALE</span></h1>
		                                 <h2>UPTo 10% OFF</h2>
